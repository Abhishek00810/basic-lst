...
var app = express();
var API_CALL = { "accountData": { "accounts": ["oaPUrEFh7fawhpDh9fqhbUnWGtAm8nLbvoajVBsZgzg",
            "CKfFbJLf9bzNHESELpMHYnpKWCdL3uCXwGSz1HnmnggQ"] }
};
//this account XD one sent some SOL and wants your token in return
//
app.post('/helius', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var fromAddress, toAddress, amount, type;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fromAddress = API_CALL.accountData.accounts[0];
